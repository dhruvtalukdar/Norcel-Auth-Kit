...
/**
 * 4-column footer with mono-caption column headers and body-sm links.
 */
    ...
    <footer className="border-t border-hairline bg-canvas">
      <div className="mx-auto w-full max-w-[1400px] px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          {COLUMNS.map((col) => (
            <div key={col.title}>
              <p className="text-caption-mono uppercase tracking-tight text-mute">
                {col.title}
              </p>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-hairline pt-8 text-caption text-mute md:flex-row md:items-center">
